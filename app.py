...
# ---------------------------------------------------------------------------
# Public page routes (kept on app because templates use url_for without prefix)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Agent config routes (modify app-level globals — kept on app)
# ---------------------------------------------------------------------------
...
# ── Inject globals into main_bp namespace ───────────────────────────────
# Routes in main_bp.py reference names like llm_adapter, executioner, etc.
# as bare globals.  We populate the module's __dict__ at boot time so
# those lookups succeed at request time.
