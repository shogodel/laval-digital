...
if __name__ == "__main__":
    ...
    print("Initializing BacklinksAgent...")
    agent = BacklinksAgent("backlinks_test", config)
    ...
    if api_key:
        ...
        result = graph.invoke({
            "task": "Build backlinks for a plumber in Laval with a new website",
            "draft_output": None,
            "approved": None,
            "feedback": None,
            "result": None,
