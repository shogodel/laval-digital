...
if __name__ == "__main__":
    ...
    print("Initializing LeadConversionAgent...")
    agent = LeadConversionAgent("lead_conversion_test", config)
    ...
    if api_key:
        ...
        result = graph.invoke({
            "task": "Design a lead qualification chatbot for a 24/7 emergency plumber in Laval",
            "draft_output": None,
            "approved": None,
            "feedback": None,
            "result": None,
