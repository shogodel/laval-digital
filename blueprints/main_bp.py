...
@main_bp.route("/api/executioner/settings", methods=["GET", "PUT"])
@admin_required
...
@main_bp.route("/api/executioner/test-smtp", methods=["POST"])
@admin_required
def test_smtp():
    data = request.json
    if not data:
...
@main_bp.route("/api/executioner/validate-social-key", methods=["POST"])
@admin_required
...
@main_bp.route("/api/executioner/social-settings", methods=["POST"])
@admin_required
...
@main_bp.route("/api/executioner/pending", methods=["GET"])
@admin_required
def get_pending_executions():
    return api_success({"pending": executioner.get_pending_executions()})

@main_bp.route("/api/executioner/confirm/<execution_id>", methods=["POST"])
@admin_required
...
@main_bp.route("/api/executioner/reject/<execution_id>", methods=["POST"])
@admin_required
...
@main_bp.route("/api/executioner/execute-chat", methods=["POST"])
@admin_required
