...
class SocialMCPServer(MCPServer):
    ...
    def post_to_tiktok(self, content: str, media_url: str = "", api_credentials: dict[str, Any] | None = None, **kwargs) -> dict[str, Any]:
    ...
    def post_to_youtube(self, content: str, media_url: str = "", api_credentials: dict[str, Any] | None = None, **kwargs) -> dict[str, Any]:
        """Post to YouTube: video upload with title, description, tags, and thumbnail."""
        if api_credentials and api_credentials.get("access_token"):
            return {"success": True, "result": "YouTube upload initiated via API", "error": None}
        return self._queue_social("youtube", content, "video")

    def post_to_threads(self, content: str, media_url: str = "", api_credentials: dict[str, Any] | None = None, **kwargs) -> dict[str, Any]:
        """Post to Threads: text, image, or video."""
        if api_credentials and api_credentials.get("access_token"):
            try:
                token = api_credentials["access_token"]
    ...
    def crosspost_content(self, content: str, platforms: str = "", api_credentials: dict[str, Any] | None = None, **kwargs) -> dict[str, Any]:
    ...
    def get_social_stats(self, platform: str = "", api_credentials: dict[str, Any] | None = None, **kwargs) -> dict[str, Any]:
        """Get engagement stats across connected platforms."""
        return {
            "success": True,
    ...
    def track_social_links(self, api_credentials: dict[str, Any] | None = None, **kwargs) -> dict[str, Any]:
