...
class GMBMCPServer(MCPServer):
    ...
    def create_gmb_post(self, content: str, post_type: str = "standard", event_start: str = "", event_end: str = "",
                        coupon_code: str = "", offer_url: str = "", api_credentials: dict[str, Any] | None = None, **kwargs) -> dict[str, Any]:
    ...
    def update_business_info(self, api_credentials: dict[str, Any] | None = None, **kwargs) -> dict[str, Any]:
    ...
    def get_insights(self, api_credentials: dict[str, Any] | None = None, **kwargs) -> dict[str, Any]:
    ...
    def optimize_gmb_profile(self, business_name: str = "", api_credentials: dict[str, Any] | None = None, **kwargs) -> dict[str, Any]:
    ...
    def create_gmb_product(self, product_name: str = "", product_description: str = "", price: str = "",
                           category: str = "service", api_credentials: dict[str, Any] | None = None, **kwargs) -> dict[str, Any]:
    ...
    def track_local_rankings(self, keywords: str = "", location: str = "", api_credentials: dict[str, Any] | None = None, **kwargs) -> dict[str, Any]:
    ...
    def manage_gmb_messages(self, action: str = "setup", api_credentials: dict[str, Any] | None = None, **kwargs) -> dict[str, Any]:
    ...
    def generate_gmb_report(self, month: str = "", api_credentials: dict[str, Any] | None = None, **kwargs) -> dict[str, Any]:
        """Generate a monthly GMB performance report."""
        try:
    ...
    def setup_appointment_booking(self, booking_url: str = "", api_credentials: dict[str, Any] | None = None, **kwargs) -> dict[str, Any]:
